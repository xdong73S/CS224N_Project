...
from models import BiDAF, QANet, MatchLSTM
...
def main(args):
    ...
    elif args.name == 'match_lstm':
        model = MatchLSTM(word_vectors=word_vectors,
                          char_vectors=char_vectors,
                          hidden_size=args.hidden_size,
                          drop_prob=args.qanet_dropout,
                          char_drop_prob=args.qanet_char_dropout,
                          use_char_emb=args.baseline_use_char_emb)
    ...
    if args.name == 'baseline' or args.name == "match_lstm":
        ...
        with torch.enable_grad(), tqdm(total=len(train_loader.dataset)) as progress_bar:
            ...
            for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids in train_loader:
                ...
                if args.name == 'baseline':
                    ...
                    ans_range_prop, ans_range = model(cw_idxs, cc_idxs, qw_idxs, qc_idxs)
                    log_p1, log_p2 = torch.log(ans_range_prop[:, 0, :]), torch.log(ans_range_prop[:, 1, :])
